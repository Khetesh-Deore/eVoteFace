...
// ── Indexes ──
userSchema.index({ electionId: 1, email: 1 },         { unique: true });
userSchema.index({ electionId: 1, voterID: 1 },       { unique: true });
userSchema.index({ electionId: 1, aadharNumber: 1 },  { unique: true });
userSchema.index({ electionId: 1, walletAddress: 1 }, { unique: true, sparse: true }); // sparse: allows multiple empty strings
